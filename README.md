# Odin Recipes
The goal of this project is to build a basic recipe website using only HTML. The website consists of a main index page that links to several recipe pages.
